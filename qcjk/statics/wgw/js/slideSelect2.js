...
slideSelector.prototype = {
    init: function () {
        ...
        var parentDom = this.parentDom = document.querySelector('.warpper') || document.body;
    ...
    tpl: '<header class="slide-header"><span class="slide-cancel">取消</span><span class="slide-sure">确定</span></header>' +
    ...
    show: function (data) {
        ...
        document.querySelector('.mask-layer').className = document.querySelector('.mask-layer').className + ' show';
        this.bindEvent();
    },
    render: function () {
